/*
    Quaternion Explicit Complimentary Filter Orientation Visualization
    ...
    - Using Explicit Complimentary Filter for orientation estimation with quaternions instead of euler coordinates
...
void draw() 
{
  ...
  textSize(25);
  fill(255, 255, 255);
  text("ECF Orientation Estimation", -183, 10, 101);
